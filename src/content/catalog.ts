...
export const creators: CreatorSource[] = [
  {
    ...
    avatar: '/images/creators/virginia-gambardella.jpg',
    platforms: [
  ...
  },
  {
    ...
    avatar: '/images/creators/theoxcatalano.jpg',
  ...
  },
  {
    ...
    avatar: '/images/creators/poci-tv.jpg',
    platforms: [
  ...
  },
  {
    ...
    platforms: [
      ...
      { platform: 'website', url: 'https://www.alessiocarciofi.com/' },
      { platform: 'linkedin', url: 'https://www.linkedin.com/in/alessiocarciofi-wellbeing' },
    ],
    featured: true,
  },
  {
    ...
    platforms: [
      ...
      { platform: 'youtube', url: 'https://www.youtube.com/@SmartBreak' },
      { platform: 'website', url: 'https://www.smartbreak.it/' },
      { platform: 'linkedin', url: 'https://www.linkedin.com/in/monicabormetti' },
    ],
    featured: true,
  },
]
